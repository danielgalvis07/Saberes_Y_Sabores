      ...
      <div className="imagenInicio">
        ...
        <div className="misionVision">
          ...
          <h1 className="tituloInicioPaginaMV tituloMision">MISIÓN</h1>
            <img src="https://cdn-icons-png.flaticon.com/128/3940/3940986.png" alt="" className="imagenVisionMision"/>
          ...
          <h1 className="tituloInicioPaginaMV tituloVision">VISIÓN</h1>
            <img src="https://cdn-icons-png.flaticon.com/128/702/702814.png" alt="" className="imagenVisionMision"/>
